...
# Automated Screenshot Capture for BUBBLE Lab
...
func _process(_delta: float) -> bool:
	...
	if frames_waited == 1:
		print("[SCREENSHOT] Loading bubble_lab.tscn after autoloads initialization...")
		var scene_res: PackedScene = load("res://scenes/testlabs/bubble_lab.tscn")
		if scene_res:
			...
			printerr("[SCREENSHOT] Failed to load bubble_lab.tscn")
			quit(1)
			return true
	...
	if frames_waited == 45:
		...
		if img:
			var save_path := "docs/screenshots/bubble_lab.png"
